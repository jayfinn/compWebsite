...
<head>
 ...
 var codesite_token = "ZO_QML77aM9eYNLzD_SHqMKm3dY:1354171139490";
 
 
 var CS_env = {"relativeBaseUrl":"","loggedInUserEmail":"whhhmarks@gmail.com","domainName":null,"assetHostPath":"https://ssl.gstatic.com/codesite/ph","projectName":"compcrimson","profileUrl":"/u/100545230244848929459/","assetVersionPath":"https://ssl.gstatic.com/codesite/ph/13882333484250518008","projectHomeUrl":"/p/compcrimson","token":"ZO_QML77aM9eYNLzD_SHqMKm3dY:1354171139490"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Fcompcrimson%2Fsource%2Fbrowse%2Fpytz%2Fgae.py" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/compcrimson/source/browse/pytz/">pytz</a><span class="sp">/&nbsp;</span>gae.py</span>
 ...
 <a href="/p/compcrimson/source/browse/pytz/gae.py?edit=1"
...
><td class="source">    A pytz version that runs smoothly on Google App Engine.<br></td></tr
><tr
...
><td class="source">    Based on http://appengine-cookbook.appspot.com/recipe/caching-pytz-helper/<br></td></tr
><tr
...
><td class="source">    To use, add pytz to your path normally, but import it from the gae module:<br></td></tr
><tr
...
><td class="source">        from pytz.gae import pytz<br></td></tr
><tr
...
><td class="source">    Applied patches:<br></td></tr
><tr
...
><td class="source">      - The zoneinfo dir is removed from pytz, as this module includes a ziped<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_13

><td class="source">        version of it.<br></td></tr
><tr
...
><td class="source">      - pytz is monkey patched to load zoneinfos from a zipfile.<br></td></tr
><tr
...
><td class="source">      - pytz is patched to not check all zoneinfo files when loaded. This is<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_18

><td class="source">        sad, I wish that was lazy, so it could be monkey patched. As it is,<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_19

><td class="source">        the zipfile patch doesn&#39;t work and it&#39;ll spend resources checking<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_20

><td class="source">        hundreds of files that we know aren&#39;t there.<br></td></tr
><tr
...
><td class="source">    pytz caches loaded zoneinfos, and this module will additionally cache them<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_23

><td class="source">    in memcache to avoid unzipping constantly. The cache key includes the<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_24

><td class="source">    OLSON_VERSION so it is invalidated when pytz is updated.<br></td></tr
><tr
...
><td class="source">import zipfile<br></td></tr
><tr
...
><td class="source"># Fake memcache for when we&#39;re not running under the SDK, likely a script.<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_33

><td class="source">class memcache(object):<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_34

><td class="source">    @classmethod<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_35

><td class="source">    def add(*args, **kwargs):<br></td></tr
><tr
...
><td class="source">    def get(*args, **kwargs):<br></td></tr
><tr
...
><td class="source">    # Don&#39;t use memcache outside of Google App Engine or with GAE&#39;s dev server.<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_44

><td class="source">    if not os.environ.get(&#39;SERVER_SOFTWARE&#39;, &#39;&#39;).startswith(&#39;Development&#39;):<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_45

><td class="source">        from google.appengine.api import memcache<br></td></tr
><tr
...
><td class="source">zoneinfo = None<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_50

><td class="source">zoneinfo_path = os.path.abspath(os.path.join(os.path.dirname(__file__),<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_51

><td class="source">    &#39;zoneinfo.zip&#39;))<br></td></tr
><tr
...
><td class="source">def get_zoneinfo():<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_55

><td class="source">    &quot;&quot;&quot;Cache the opened zipfile in the module.&quot;&quot;&quot;<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_56

><td class="source">    global zoneinfo<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_57

><td class="source">    if zoneinfo is None:<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_58

><td class="source">        zoneinfo = zipfile.ZipFile(zoneinfo_path)<br></td></tr
><tr
...
><td class="source">    return zoneinfo<br></td></tr
><tr
...
><td class="source">    &quot;&quot;&quot;A loader that that reads timezones using ZipFile.&quot;&quot;&quot;<br></td></tr
><tr
...
><td class="source">        &quot;&quot;&quot;Opens a resource from the zoneinfo subdir for reading.&quot;&quot;&quot;<br></td></tr
><tr
...
><td class="source">        if os.path.pardir in name_parts:<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_72

><td class="source">            raise ValueError(&#39;Bad path segment: %r&#39; % os.path.pardir)<br></td></tr
><tr
...
><td class="source">        cache_key = &#39;pytz.zoneinfo.%s.%s&#39; % (pytz.OLSON_VERSION, name)<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_75

><td class="source">        zonedata = memcache.get(cache_key)<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_76

><td class="source">        if zonedata is None:<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_77

><td class="source">            zonedata = get_zoneinfo().read(&#39;zoneinfo/&#39; + &#39;/&#39;.join(name_parts))<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_78

><td class="source">            memcache.add(cache_key, zonedata)<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_79

><td class="source">            logging.info(&#39;Added timezone to memcache: %s&#39; % cache_key)<br></td></tr
><tr
...
><td class="source">            logging.info(&#39;Loaded timezone from memcache: %s&#39; % cache_key)<br></td></tr
><tr
...
><td class="source">        return StringIO(zonedata)<br></td></tr
><tr
...
><td class="source">                get_zoneinfo().getinfo(&#39;zoneinfo/&#39; + name)<br></td></tr
><tr
...
><td class="source">pytz.loader = TimezoneLoader()<br></td></tr
></table></pre>
<pre><table width="100%"><tr class="cursor_stop cursor_hidden"><td></td></tr></table></pre>
</td>
</tr></table>
...
<script type="text/javascript">
 ...
 on Feb 22, 2012
 &nbsp; <a href="/p/compcrimson/source/diff?spec=svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac&r=550fef0d0b3cc8780a645e6c68e7c5447d51b868&amp;format=side&amp;path=/pytz/gae.py&amp;old_path=/pytz/gae.py&amp;old=">Diff</a>
 </div>
 ...
 <a href="/p/compcrimson/source/list?path=/pytz/gae.py&r=550fef0d0b3cc8780a645e6c68e7c5447d51b868">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//compcrimson.googlecode.com/git/pytz/gae.py">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac': '/pytz/gae.py'}
 codereviews = CR_controller.setup(
 {"relativeBaseUrl":"","loggedInUserEmail":"whhhmarks@gmail.com","domainName":null,"assetHostPath":"https://ssl.gstatic.com/codesite/ph","projectName":"compcrimson","profileUrl":"/u/100545230244848929459/","assetVersionPath":"https://ssl.gstatic.com/codesite/ph/13882333484250518008","projectHomeUrl":"/p/compcrimson","token":"ZO_QML77aM9eYNLzD_SHqMKm3dY:1354171139490"}, '', 'svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac', paths,
