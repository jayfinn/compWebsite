...
<head>
 ...
 var codesite_token = "93_25shLy1z1rJjAUypJM3FfKw8:1354171143031";
 
 
 var CS_env = {"domainName":null,"relativeBaseUrl":"","profileUrl":"/u/100545230244848929459/","assetVersionPath":"https://ssl.gstatic.com/codesite/ph/13882333484250518008","token":"93_25shLy1z1rJjAUypJM3FfKw8:1354171143031","assetHostPath":"https://ssl.gstatic.com/codesite/ph","projectHomeUrl":"/p/compcrimson","loggedInUserEmail":"whhhmarks@gmail.com","projectName":"compcrimson"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Fcompcrimson%2Fsource%2Fbrowse%2Fpytz%2Freference.py" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/compcrimson/source/browse/pytz/">pytz</a><span class="sp">/&nbsp;</span>reference.py</span>
 ...
 <a href="/p/compcrimson/source/browse/pytz/reference.py?edit=1"
...
><td class="source">Reference tzinfo implementations from the Python docs.<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_3

><td class="source">Used for testing against as they are only correct for the years<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_4

><td class="source">1987 to 2006. Do not use these for real code.<br></td></tr
><tr
...
><td class="source">from datetime import tzinfo, timedelta, datetime<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_8

><td class="source">from pytz import utc, UTC, HOUR, ZERO<br></td></tr
><tr
...
><td class="source"># A class building tzinfo objects for fixed-offset time zones.<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_11

><td class="source"># Note that FixedOffset(0, &quot;UTC&quot;) is a different way to build a<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_12

><td class="source"># UTC tzinfo object.<br></td></tr
><tr
...
><td class="source">class FixedOffset(tzinfo):<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_15

><td class="source">    &quot;&quot;&quot;Fixed offset in minutes east from UTC.&quot;&quot;&quot;<br></td></tr
><tr
...
><td class="source">    def __init__(self, offset, name):<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_18

><td class="source">        self.__offset = timedelta(minutes = offset)<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_19

><td class="source">        self.__name = name<br></td></tr
><tr
...
><td class="source">        return self.__offset<br></td></tr
><tr
...
><td class="source">        return self.__name<br></td></tr
><tr
...
><td class="source"># A class capturing the platform&#39;s idea of local time.<br></td></tr
><tr
...
><td class="source">import time as _time<br></td></tr
><tr
...
><td class="source">STDOFFSET = timedelta(seconds = -_time.timezone)<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_35

><td class="source">if _time.daylight:<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_36

><td class="source">    DSTOFFSET = timedelta(seconds = -_time.altzone)<br></td></tr
><tr
...
><td class="source">    DSTOFFSET = STDOFFSET<br></td></tr
><tr
...
><td class="source">DSTDIFF = DSTOFFSET - STDOFFSET<br></td></tr
><tr
...
><td class="source">class LocalTimezone(tzinfo):<br></td></tr
><tr
...
><td class="source">        if self._isdst(dt):<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_46

><td class="source">            return DSTOFFSET<br></td></tr
><tr
...
><td class="source">            return STDOFFSET<br></td></tr
><tr
...
><td class="source">            return DSTDIFF<br></td></tr
><tr
...
><td class="source">        return _time.tzname[self._isdst(dt)]<br></td></tr
><tr
...
><td class="source">    def _isdst(self, dt):<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_60

><td class="source">        tt = (dt.year, dt.month, dt.day,<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_61

><td class="source">              dt.hour, dt.minute, dt.second,<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_62

><td class="source">              dt.weekday(), 0, -1)<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_63

><td class="source">        stamp = _time.mktime(tt)<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_64

><td class="source">        tt = _time.localtime(stamp)<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_65

><td class="source">        return tt.tm_isdst &gt; 0<br></td></tr
><tr
...
><td class="source">Local = LocalTimezone()<br></td></tr
><tr
...
><td class="source"># A complete implementation of current DST rules for major US time zones.<br></td></tr
><tr
...
><td class="source">def first_sunday_on_or_after(dt):<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_72

><td class="source">    days_to_go = 6 - dt.weekday()<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_73

><td class="source">    if days_to_go:<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_74

><td class="source">        dt += timedelta(days_to_go)<br></td></tr
><tr
...
><td class="source"># In the US, DST starts at 2am (standard time) on the first Sunday in April.<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_78

><td class="source">DSTSTART = datetime(1, 4, 1, 2)<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_79

><td class="source"># and ends at 2am (DST time; 1am standard time) on the last Sunday of Oct.<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_80

><td class="source"># which is the first Sunday on or after Oct 25.<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_81

><td class="source">DSTEND = datetime(1, 10, 25, 1)<br></td></tr
><tr
...
><td class="source">class USTimeZone(tzinfo):<br></td></tr
><tr
...
><td class="source">    def __init__(self, hours, reprname, stdname, dstname):<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_86

><td class="source">        self.stdoffset = timedelta(hours=hours)<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_87

><td class="source">        self.reprname = reprname<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_88

><td class="source">        self.stdname = stdname<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_89

><td class="source">        self.dstname = dstname<br></td></tr
><tr
...
><td class="source">        return self.reprname<br></td></tr
><tr
...
><td class="source">        if self.dst(dt):<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_96

><td class="source">            return self.dstname<br></td></tr
><tr
...
><td class="source">            return self.stdname<br></td></tr
><tr
...
><td class="source">        return self.stdoffset + self.dst(dt)<br></td></tr
><tr
...
><td class="source">        if dt is None or dt.tzinfo is None:<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_105

><td class="source">            # An exception may be sensible here, in one or both cases.<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_106

><td class="source">            # It depends on how you want to treat them.  The default<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_107

><td class="source">            # fromutc() implementation (called by the default astimezone()<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_108

><td class="source">            # implementation) passes a datetime with dt.tzinfo is self.<br></td></tr
><tr
...
><td class="source">        assert dt.tzinfo is self<br></td></tr
><tr
...
><td class="source">        # Find first Sunday in April &amp; the last in October.<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_113

><td class="source">        start = first_sunday_on_or_after(DSTSTART.replace(year=dt.year))<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_114

><td class="source">        end = first_sunday_on_or_after(DSTEND.replace(year=dt.year))<br></td></tr
><tr
...
><td class="source">        # Can&#39;t compare naive to aware objects, so strip the timezone from<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_117

><td class="source">        # dt first.<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_118

><td class="source">        if start &lt;= dt.replace(tzinfo=None) &lt; end:<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_119

><td class="source">            return HOUR<br></td></tr
><tr
...
><td class="source">Eastern  = USTimeZone(-5, &quot;Eastern&quot;,  &quot;EST&quot;, &quot;EDT&quot;)<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_124

><td class="source">Central  = USTimeZone(-6, &quot;Central&quot;,  &quot;CST&quot;, &quot;CDT&quot;)<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_125

><td class="source">Mountain = USTimeZone(-7, &quot;Mountain&quot;, &quot;MST&quot;, &quot;MDT&quot;)<br></td></tr
><tr
id=sl_svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac_126

><td class="source">Pacific  = USTimeZone(-8, &quot;Pacific&quot;,  &quot;PST&quot;, &quot;PDT&quot;)<br></td></tr
><tr
...
<script type="text/javascript">
 ...
 on Feb 22, 2012
 &nbsp; <a href="/p/compcrimson/source/diff?spec=svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac&r=550fef0d0b3cc8780a645e6c68e7c5447d51b868&amp;format=side&amp;path=/pytz/reference.py&amp;old_path=/pytz/reference.py&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/pytz/reference.py';
 ...
 <a href="/p/compcrimson/source/list?path=/pytz/reference.py&r=550fef0d0b3cc8780a645e6c68e7c5447d51b868">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//compcrimson.googlecode.com/git/pytz/reference.py">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac': '/pytz/reference.py'}
 codereviews = CR_controller.setup(
 {"domainName":null,"relativeBaseUrl":"","profileUrl":"/u/100545230244848929459/","assetVersionPath":"https://ssl.gstatic.com/codesite/ph/13882333484250518008","token":"93_25shLy1z1rJjAUypJM3FfKw8:1354171143031","assetHostPath":"https://ssl.gstatic.com/codesite/ph","projectHomeUrl":"/p/compcrimson","loggedInUserEmail":"whhhmarks@gmail.com","projectName":"compcrimson"}, '', 'svne87ef8b7cfd1fcfcf7a7ad8308624232cd1efdac', paths,
